...
sample_table_original<-sample_table
head(sample_table)
```
...
M[M$status=="healthy",]<-NA

# Calculate variance attributed to metadata


M<-M[,which(colnames(M) %in% c("Total.white.blood.cell.count...mm3.", "Total.neutrophil.count...mm3.","Total.lymphocyte.count...mm3.","age","gender","SOFA","Intubated","Outcome","Immune_classification","Charlson","PneumoniaIndex","diabetes2","Chronic_heart_failure","Chronic_renal_disease","Coronary_heart_disease","Dyslipidemia","Hypothyroidism","Hypertension","WHO"))]
...
#Fig S1F Clinical contribution PC1 in COVID19 patients
...
sample_table_clustered[sample_table_clustered$status=="healthy","aggl.clust.5.omix"]<-0
```
